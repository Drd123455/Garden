    ...
    <div className={`rounded-lg border-2 transition-all ${
      ...
      <button
        ...
        className={`flex items-center gap-3 w-full p-4 text-left cursor-pointer ${
          currentSection === section ? "bg-green-50" : "bg-white hover:bg-gray-50"
        }`}
      >
      ...
      <div className="p-4 bg-gradient-to-r from-green-500 to-green-600">
        <div className="flex items-center gap-3 text-white">
          <button 
            ...
            className="text-2xl hover:text-green-100 transition-colors cursor-pointer"
          >
            ←
          </button>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border-gray-300 rounded-md text-sm font-bold focus:outline-none focus:border-green-500"
                >
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`p-3 rounded-lg border-2 flex flex-col items-center gap-1 cursor-pointer ${
